...
These are some projects I worked on while learning C# and the .NET Framework
...
This project is an MVC web application that simulates a basic car insurance website. It takes user
